...
public class WorkControllerImpl implements IWorkController {
	...
	public ModelAndView addWorkController(HttpSession session, MultipartFile file, @Valid WorkForAdd work,BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			return Common.handleVaildError(bindingResult);
		}
		ModelAndView modelAndView = new ModelAndView();
	...
	public ModelAndView removeWorkController(HttpSession session, @Valid WorkForModify work,BindingResult bindingResult) {
		if (bindingResult.hasErrors()) {
			return Common.handleVaildError(bindingResult);
		}
		ModelAndView modelAndView = new ModelAndView();
